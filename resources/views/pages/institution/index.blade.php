...
<div class="page-heading">
    <div class="page-title mb-3">
        <h3>
            <span class="bi bi-building"></span>Institution
        </h3>
    </div>

    <a href="{{ route('admin.institution.create') }}" class="btn btn-primary btn-sm mb-3">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="#" class="btn btn-outline-secondary btn-sm me-1" onclick="handleDestroy(`{{ route('admin.institution.destroy', $item->id) }}`)">
